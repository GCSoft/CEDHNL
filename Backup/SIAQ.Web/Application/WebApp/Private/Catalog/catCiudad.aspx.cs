	...
	public partial class catCiudad : BPPage
	{
		...
		private void insertCiudad()
		{
			...
			try
			{
				...
				// Mensaje al usuario
				ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "alert('Ciudad creada con éxito!'); focusControl('" + this.txtNombre.ClientID + "');", true);
