   ...
   public partial class catColonia : BPPage
   {
       ...
       private void insertColonia()
       {
           ...
           try
           {
               ...
               // Mensaje al usuario
			   ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "alert('Colonia creado con éxito!'); focusControl('" + this.txtNombre.ClientID + "');", true);
