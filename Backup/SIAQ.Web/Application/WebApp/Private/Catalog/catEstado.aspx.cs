	...
	public partial class catEstado : System.Web.UI.Page
	{
        ...
        private void insertEstado()
        {
            ...
            try
            {
                ...
                // Mensaje al usuario
				ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "alert('Estado creado con éxito!'); focusControl('" + this.txtNombre.ClientID + "');", true);
