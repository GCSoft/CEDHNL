<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catLugarDiligencia.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catLugarDiligencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
			<td class="tdCeldaTituloEncabezado" style="background-image:url('../../../../Include/Image/Web/BarraTitulo.png');">
				Catálogo Lugar de la Diligencia
			</td>
		</tr>
   ...
   <asp:HiddenField ID="hddLugarDiligencia" runat="server" value="" />
