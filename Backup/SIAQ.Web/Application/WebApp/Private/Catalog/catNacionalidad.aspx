<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catNacionalidad.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catNacionalidad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
   <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
			<td class="tdCeldaTituloEncabezado" style="background-image:url('../../../../Include/Image/Web/BarraTitulo.png');">
				Catálogo de Nacionalidades de Ciudadanos
			</td>
		</tr>
        ...
        <td>
	        <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
		        <table border="0" cellpadding="0" cellspacing="0" style="text-align:left; font-size:11px" width="100%">
                    <tr>
                        <td colspan="3">Proporcione los filtros deseados para buscar la Nacionalidad </td>
                    </tr>
      ...
      <tr>
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvNacionalidad" runat="server" AllowPaging="false" 
                    AllowSorting="true" AutoGenerateColumns="False" Width="100%"
					DataKeyNames="NacionalidadId, Nombre" onrowcommand="gvNacionalidad_RowCommand" 
                    onrowdatabound="gvNacionalidad_RowDataBound" onsorting="gvNacionalidad_Sorting">
						...
						<EmptyDataTemplate>
							<table border="1px" cellpadding="0px" cellspacing="0px" Width="100%">
								...
								<tr class="Grid_Row">
									<td colspan="3">No se encontraron nacionalidades registradas en el sistema</td>
								</tr>
							</table>
						</EmptyDataTemplate>
						<Columns>
   ...
   <asp:HiddenField ID="hddNacionalidad" runat="server" value="" />
