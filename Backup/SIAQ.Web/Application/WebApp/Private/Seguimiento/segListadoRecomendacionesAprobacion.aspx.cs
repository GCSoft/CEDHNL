/*---------------------------------------------------------------------------------------------------------------------------------
' Nombre:	    segListadoRecomendacionesAprobacion
' Autor:		Ruben.Cobos
...
{
	public partial class segListadoRecomendacionesAprobacion : BPPage
	{
			...
			try
			{
				...
				switch (strCommand){
					case "Editar":
						...
						this.Response.Redirect("segDetalleRecomendacionCierre.aspx?key=" + sKey, false);
						break;
				}
