...
{
	public partial class visAtencionVictimas : System.Web.UI.Page
	{
		...
		void InsertAtencion(){
			...
			try
			{
			   ...
			   // Obtener Sesion
				...
				oENTAtencion.ModuloId = 3; // Visitadurias
		...
		void SelectExpediente() {
			...
			try
			{
				...
				// Atenciones
				this.gvAtencion.DataSource = oENTResponse.dsResponse.Tables[14];
