	...
	public class BPUsuario : BPBase
	{
		...
		public ENTResponse SelectUsuario_RecuperaContrasena(ENTUsuario oENTUsuario){
			...
			try
			{
				...
				sPassword = gcEncryption.DecryptString(oENTResponse.dsResponse.Tables[1].Rows[0]["sPassword"].ToString(), false);
				...
				// Enviar correo
				gcMail.Send("SIAQ - Recuperación de contraseña", oENTUsuario.sEmail, "SIAQ - Recuperación de contraseña", sHTMLMessage);
