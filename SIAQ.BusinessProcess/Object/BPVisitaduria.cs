...
namespace SIAQ.BusinessProcess.Object
{
	public class BPVisitaduria : BPBase
	{
		...
		///<remarks>
		///   <name>BPVisitaduria.DeleteExpedienteAutoridadVoces</name>
		///   <create>27-Agosto-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		...
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse DeleteExpedienteAutoridadVoces(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.DeleteExpedienteAutoridadVoces(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.DeleteExpedienteCiudadano</name>
		///   <create>08-Septiembre-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		///<summary>Elimina un ciudadano asociado al Expediente</summary>
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse DeleteExpedienteCiudadano(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.DeleteExpedienteCiudadano(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.InsertExpedienteAutoridad</name>
		///   <create>27-Agosto-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		...
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse InsertExpedienteAutoridad(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.InsertExpedienteAutoridad(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.InsertExpedienteAutoridadVoces</name>
		///   <create>08-Septiembre-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		...
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse InsertExpedienteAutoridadVoces(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.InsertExpedienteAutoridadVoces(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.InsertExpedienteCiudadano</name>
		///   <create>08-Septiembre-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		///<summary>Asocia un nuevo ciudadano al Expediente</summary>
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse InsertExpedienteCiudadano(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.InsertExpedienteCiudadano(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.rptGeneralVisitaduria</name>
        ...
        ///<param name="oENTVisitaduria">Entidad de Visitaduria con los parámetros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse RptGeneralVisitaduria(ENTVisitaduria oENTVisitaduria)
        {
            DAVisitaduria oDAVisitaduria = new DAVisitaduria();
            ENTResponse oENTResponse = new ENTResponse();
            ...
            try
            {
                ...
                // Transacción en base de datos
                oENTResponse = oDAVisitaduria.RptGeneralVisitaduria(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.SelectCalificacionVoz</name>
		///   <create>27-Agosto-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		///<summary>Obtiene un listado de Calificaciones de Voz en base a los parámetros proporcionados</summary>
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para la consulta</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse SelectCalificacionVoz(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.SelectCalificacionVoz(oENTVisitaduria, this.sConnectionApplication, 0);
		...
		///<remarks>
		///   <name>BPVisitaduria.UpdateExpediente_CambioArea</name>
		///   <create>27-Agosto-2014</create>
        ///   <author>Ruben.Cobos</author>
        ///</remarks>
		...
		///<param name="oENTVisitaduria">Entidad de Visitadurías con los filtros necesarios para realizar la transacción</param>
        ///<returns>Una entidad de respuesta</returns>
        public ENTResponse UpdateExpediente_CambioArea(ENTVisitaduria oENTVisitaduria){
           DAVisitaduria oDAVisitaduria = new DAVisitaduria();
           ENTResponse oENTResponse = new ENTResponse();
           ...
           try
           {
              ...
              // Transacción en base de datos
			   oENTResponse = oDAVisitaduria.UpdateExpediente_CambioArea(oENTVisitaduria, this.sConnectionApplication, 0);
