...
namespace SIAQ.DataAccess.Object
{
    public class DACiudad : DABase
    {
      ...
      public ENTResponse insertcatCiudad(ENTCiudad oENTCiudad)
		...
		///<remarks>
		///   <name>DAEstado.InsertCiudad_FastCatalog</name>
		///   <create>17-Julio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		///<summary>Crea una nueva Ciudad desde el wucFastCatalog</summary>
		///<param name="oENTCiudad">Entidad de Ciudad con los parámetros necesarios para crear el registro</param>
		///<param name="sConnection">Cadena de conexión a la base de datos</param>
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
		public ENTResponse InsertCiudad_FastCatalog(ENTCiudad oENTCiudad, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspcatCiudad_Ins_FastCatalog", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			sqlPar.Value = oENTCiudad.Descripcion;
			sqlCom.Parameters.Add(sqlPar);
