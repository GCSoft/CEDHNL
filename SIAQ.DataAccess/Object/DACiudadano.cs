...
namespace SIAQ.DataAccess.Object
{
    public class DACiudadano : DABase
	{
		...
		///<remarks>
		///   <name>DACiudadano.SelectCiudadano_ByID</name>
		///   <create>06-Julio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		///<summary>Consulta un ciudadano por su ID único</summary>
		///<param name="oENTCiudadano">Entidad de Ciudadano con los parámetros necesarios para crear la relación</param>
		///<param name="sConnection">Cadena de conexión a la base de datos</param>
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
		public ENTResponse SelectCiudadano_ByID(ENTCiudadano oENTCiudadano, String sConnection, Int32 iAlternateDBTimeout){
			...
			sqlCom = new SqlCommand("uspCiudadano_Sel_ByID", sqlCnn);
