...
namespace SIAQ.DataAccess.Object
{
    public class DAColonia : DABase
    {
      ...
      public ENTResponse SelectColonia(ENTColonia oENTColonia, String sConnection, Int32 iAlternateDBTimeout){
		...
		///<remarks>
		///   <name>DAColonia.InsertColonia_FastCatalog</name>
		...
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
		public ENTResponse InsertColonia_FastCatalog(ENTColonia oENTColonia, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspcatColonia_Ins_FastCatalog", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
