...
{
    public class DALugarComparecencia : DABase
    {
        ...
        #region "Method"
            ...
            public DataSet SelectLugarComparecencia(ENTLugarComparecencia LugarComparecenciaEntity, string ConnectionString)
            {
                ...
                try
                {
                    Command = new SqlCommand("SelectLugarComparecencia", Connection);
                    Command.CommandType = CommandType.StoredProcedure;

                    Parameter = new SqlParameter("LugarComparecenciaId", SqlDbType.Int);
                    Parameter.Value = LugarComparecenciaEntity.LugarComparecenciaId;
