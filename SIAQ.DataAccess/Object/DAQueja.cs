...
namespace SIAQ.DataAccess.Object
{
	public class DAQueja : DABase
	{
		...
		///<remarks>
		///   <name>DASolicitud.DeleteSolicitudComentario</name>
		///   <create>19-Junio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		...
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
		public ENTResponse DeleteSolicitudComentario(ENTQueja oENTQueja, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspSolicitudComentario_Del", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			sqlPar.Value = oENTQueja.ComentarioId;
			sqlCom.Parameters.Add(sqlPar);
		...
		///   <author>Ruben.Cobos</author>
		///</remarks>
		///<summary>Obtiene un listado de MecanismoAperturas de Solicitudes en base a los parámetros proporcionados</summary>
		///<param name="oENTQueja">Entidad del Expediente de Solicitud de Quejas con los filtros necesarios para la consulta</param>
		///<param name="sConnection">Cadena de conexión a la base de datos</param>
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
        public ENTResponse SelectMecanismoApertura(ENTQueja oENTQueja, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspMecanismoApertura_Sel", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			// Parametros
			sqlPar = new SqlParameter("MecanismoAperturaId", SqlDbType.Int);
			sqlPar.Value = oENTQueja.MecanismoAperturaId;
			sqlCom.Parameters.Add(sqlPar);
		...
		///<remarks>
		///   <name>DAQueja.SelectNivelAutoridad</name>
		///   <create>17-Julio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		///<summary>Obtiene un listado de NivelAutoridads de Solicitudes en base a los parámetros proporcionados</summary>
		///<param name="oENTQueja">Entidad del Expediente de Solicitud de Quejas con los filtros necesarios para la consulta</param>
		///<param name="sConnection">Cadena de conexión a la base de datos</param>
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
        public ENTResponse SelectNivelAutoridad(ENTQueja oENTQueja, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspNivelAutoridad_Sel", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			// Parametros
			sqlPar = new SqlParameter("NivelAutoridadId", SqlDbType.Int);
			sqlPar.Value = oENTQueja.NivelAutoridadId;
			sqlCom.Parameters.Add(sqlPar);
		...
		///<remarks>
		///   <name>DAQueja.SelectProblematica</name>
		///   <create>17-Julio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		...
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
        public ENTResponse SelectProblematica(ENTQueja oENTQueja, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspProblematica_Sel", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			sqlPar.Value = oENTQueja.ProblematicaId;
			sqlCom.Parameters.Add(sqlPar);
		...
		///<remarks>
		///   <name>DAQueja.SelectProblematicaDetalle</name>
		///   <create>17-Julio-2014</create>
		///   <author>Ruben.Cobos</author>
		///</remarks>
		///<summary>Obtiene un listado de Problematicas de Solicitudes en base a los parámetros proporcionados</summary>
		...
		///<param name="iAlternateDBTimeout">Valor en milisegundos del Timeout en la consulta a la base de datos. 0 si se desea el Timeout por default</param>
		///<returns>Una entidad de respuesta</returns>
        public ENTResponse SelectProblematicaDetalle(ENTQueja oENTQueja, String sConnection, Int32 iAlternateDBTimeout){
			SqlConnection sqlCnn = new SqlConnection(sConnection);
			SqlCommand sqlCom;
			SqlParameter sqlPar;
			SqlDataAdapter sqlDA;
			...
			// Configuración de objetos
			sqlCom = new SqlCommand("uspProblematicaDetalle_Sel", sqlCnn);
			sqlCom.CommandType = CommandType.StoredProcedure;
			...
			// Parametros
			sqlPar = new SqlParameter("ProblematicaDetalleId", SqlDbType.Int);
			sqlPar.Value = oENTQueja.ProblematicaDetalleId;
			sqlCom.Parameters.Add(sqlPar);
