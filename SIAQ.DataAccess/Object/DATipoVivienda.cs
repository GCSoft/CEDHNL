...
{
    public class DATipoVivienda : DABase
    {
        Database dbs;
        public DATipoVivienda()
        {
            dbs = DatabaseFactory.CreateDatabase("Conn");
        }
        ///<remarks>
        ///   <name>DAcatTipoVivienda.searchcatTipoVivienda</name>
        ...
        public ENTResponse searchcatTipoVivienda(ENTTipoVivienda entTipoVivienda)
        {
            ...
            try
            {
                ds = dbs.ExecuteDataSet("catTipoViviendaSel");
        ...
        ///<remarks>
        ///   <name>DAcatTipoVivienda.insertcatTipoVivienda</name>
        ///   <create>27/ene/2014</create>
        ///   <author>Generador</author>
        ///</remarks>
        ...
        public ENTResponse insertcatTipoVivienda(ENTTipoVivienda entTipoVivienda)
        {
            ...
            try
            {
                ds = dbs.ExecuteDataSet("catTipoViviendaIns");
                oENTResponse.dsResponse = ds;
            }
            catch (SqlException sqlEx)
            {
        ...
        ///<remarks>
        ///   <name>DAcatTipoVivienda.updatecatTipoVivienda</name>
        ///   <create>27/ene/2014</create>
        ///   <author>Generador</author>
        ///</remarks>
        ...
        public ENTResponse updatecatTipoVivienda(ENTTipoVivienda entTipoVivienda)
        {
            ...
            try
            {
                dbs.ExecuteDataSet("catTipoViviendaUpd");
                oENTResponse.dsResponse = ds;
            }
            catch (SqlException sqlEx)
            {
        ...
        ///<remarks>
        ///   <name>DAcatTipoVivienda.deletecatTipoVivienda</name>
        ///   <create>27/ene/2014</create>
        ///   <author>Generador</author>
        ///</remarks>
        ...
        public ENTResponse deletecatTipoVivienda(ENTTipoVivienda entTipoVivienda)
        {
            ...
            try
            {
                dbs.ExecuteDataSet("catTipoViviendaDel");
                oENTResponse.dsResponse = ds;
            }
            catch (SqlException sqlEx)
            {
