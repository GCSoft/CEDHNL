...
{
   public partial class catColonia : System.Web.UI.Page
   {
      ...
      protected void gvColonia_Sorting(object sender, GridViewSortEventArgs e)
      {
          ...
          try
          {
              ...
              tblRegionesTelcel = utilFunction.ParseGridViewToDataTable(this.gvColonia, true);
              ...
              // Vaciar datos
              this.gvColonia.DataSource = viewRegionesTelcel;
              this.gvColonia.DataBind();
