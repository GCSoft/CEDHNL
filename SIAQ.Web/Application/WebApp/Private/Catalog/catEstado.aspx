<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catEstado.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catEstado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
                  ...
                  <asp:Panel ID="pnlActionBody" runat="server" CssClass="ActionBody">
                     <div style="margin:0 auto; width:98%;">
                        <table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
                            ...
                            <tr class="trFilaItem">
							    <td class="tdActionCeldaLeyendaItem">&nbsp;País</td>
							    <td></td>
							    <td class="tdCeldaItem"><asp:DropDownList id="ddlActionPais" runat="server" CssClass="DropDownList_General" width="316px" ></asp:DropDownList></td>
						    </tr>
   ...
   <asp:HiddenField ID="hddEstado" runat="server" value="" />
