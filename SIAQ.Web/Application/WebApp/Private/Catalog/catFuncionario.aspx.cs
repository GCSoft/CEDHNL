   ...
   public partial class catFuncionario : BPPage
   {
      ...
      protected void gvFuncionario_RowDataBound(object sender, GridViewRowEventArgs e){
		...
		protected void gvFuncionario_Sorting(object sender, GridViewSortEventArgs e){
         DataTable tblFuncionario = null;
         DataView viewFuncionario = null;

         try
         {

            // Obtener DataTable y DataView del GridView
            tblFuncionario = utilFunction.ParseGridViewToDataTable(this.gvFuncionario, true);
            viewFuncionario = new DataView(tblFuncionario);

            // Determinar ordenamiento
            this.hddSort.Value = (this.hddSort.Value == e.SortExpression ? e.SortExpression + " DESC" : e.SortExpression);

            // Ordenar vista
            viewFuncionario.Sort = this.hddSort.Value;

            // Vaciar datos
            this.gvFuncionario.DataSource = viewFuncionario;
            this.gvFuncionario.DataBind();
