...
{
	public partial class catLugarDiligencia : System.Web.UI.Page
	{
        ...
        protected void gvLugar_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            try
            {
                ...
                tblRegionesTelcel = utilFunction.ParseGridViewToDataTable(this.gvLugar, true);
                ...
                // Vaciar datos
                this.gvLugar.DataSource = viewRegionesTelcel;
                this.gvLugar.DataBind();
