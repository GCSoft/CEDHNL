<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catLugarHechos.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catLugarHechos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
   ...
   <asp:HiddenField ID="hddLugarHechos" runat="server" value="" />
