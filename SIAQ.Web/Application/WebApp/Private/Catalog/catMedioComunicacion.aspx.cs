...
{
	public partial class catMedioComunicacion : System.Web.UI.Page
	{
        ...
        private void insertMedioComunicacion()
        {
            ...
            try
            {
                ...
                // Mensaje al usuario
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Lugar creado con éxito!', 'Success', true); focusControl('" + this.txtNombre.ClientID + "');", true);
        ...
        protected void gvMedioComunicacion_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            try
            {
                ...
                tblRegionesTelcel = utilFunction.ParseGridViewToDataTable(this.gvMedioComunicacion, true);
                ...
                // Vaciar datos
                this.gvMedioComunicacion.DataSource = viewRegionesTelcel;
                this.gvMedioComunicacion.DataBind();
