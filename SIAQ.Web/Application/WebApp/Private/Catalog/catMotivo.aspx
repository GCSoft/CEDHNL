<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catMotivo.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catMotivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
        ...
        <td>
	        <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
		        <table border="0" cellpadding="0" cellspacing="0" style="text-align:left; font-size:11px" width="100%">
                    <tr>
                        <td colspan="3">Proporcione los filtros deseados para buscar el Motivo de Visita </td>
                    </tr>
      ...
      <tr>
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvMotivo" runat="server" AllowPaging="false" 
                    AllowSorting="true" AutoGenerateColumns="False" Width="100%"
						DataKeyNames="MotivoId, Nombre" onrowcommand="gvMotivo_RowCommand" 
                    onrowdatabound="gvMotivo_RowDataBound" onsorting="gvMotivo_Sorting">
						...
						<EmptyDataTemplate>
							<table border="1px" cellpadding="0px" cellspacing="0px" Width="100%">
								...
								<tr class="Grid_Row">
									<td colspan="3">No se encontraron motivos registrados en el sistema</td>
								</tr>
							</table>
						</EmptyDataTemplate>
						<Columns>
   ...
   <asp:HiddenField ID="hddMotivo" runat="server" value="" />
