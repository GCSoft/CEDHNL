   ...
   public partial class catNacionalidad : System.Web.UI.Page
   {
       ...
       private void insertNacionalidad()
       {
           ...
           try
           {
               ...
               // Mensaje al usuario
               ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Nacionalidad creado con éxito!', 'Success', true); focusControl('" + this.txtNombre.ClientID + "');", true);
