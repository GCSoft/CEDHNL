        ...
        <td>
	        <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
		        <table border="0" cellpadding="0" cellspacing="0" style="text-align:left; font-size:11px" width="100%">
                    <tr>
                        <td colspan="3">Proporcione los filtros deseados para buscar la Ocupación</td>
                    </tr>
      ...
      <tr>
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvOcupacion" runat="server" AllowPaging="false" 
                    AllowSorting="true" AutoGenerateColumns="False" Width="100%"
						DataKeyNames="OcupacionId, Nombre" onrowcommand="gvOcupacion_RowCommand" 
                    onrowdatabound="gvOcupacion_RowDataBound" onsorting="gvOcupacion_Sorting">
