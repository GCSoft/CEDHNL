...
{
   public partial class catOcupacion : System.Web.UI.Page
   {
       // Utilerías
       ...
       private void insertOcupacion()
       {
           ...
           try
           {
               ...
               // Mensaje al usuario
               ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Motivo creado con éxito!', 'Success', true); focusControl('" + this.txtNombre.ClientID + "');", true);
       ...
       protected void gvOcupacion_Sorting(object sender, GridViewSortEventArgs e)
       {
           ...
           try
           {
               ...
               tblRegionesTelcel = utilFunction.ParseGridViewToDataTable(this.gvOcupacion, true);
               ...
               // Vaciar datos
               this.gvOcupacion.DataSource = viewRegionesTelcel;
               this.gvOcupacion.DataBind();
