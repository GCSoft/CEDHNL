<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="catPais.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Catalog.catPais" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
				...
				<asp:Panel id="pnlBotones" runat="server" Width="100%">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<td style="height:24px; text-align:left; width:130px;"><asp:Button ID="btnExportar" runat="server" Text="Exportar" CssClass="Button_General" width="125px" Visible="false" onclick="btnExportar_Click" /></td>
		...
		<tr>
			<td>
				<asp:Panel id="pnlGrid" runat="server" Width="100%">
					<asp:GridView id="gvPais" runat="server" AllowPaging="false" AllowSorting="true"  AutoGenerateColumns="False" Width="100%"
						DataKeyNames="PaisId, tiActivo, Nombre" 
						onrowcommand="gvPais_RowCommand" 
						onrowdatabound="gvPais_RowDataBound"
						onsorting="gvPais_Sorting">
						...
						<EmptyDataTemplate>
							<table border="1px" cellpadding="0px" cellspacing="0px">
								...
								<tr class="Grid_Row">
									<td colspan="5">No se encontraron países registrados en el sistema</td>
								</tr>
							</table>
						</EmptyDataTemplate>
						<Columns>
	...
	<asp:HiddenField ID="hddPais" runat="server" value="" />
