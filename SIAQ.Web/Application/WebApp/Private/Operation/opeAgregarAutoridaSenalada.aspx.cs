...
namespace SIAQ.Web.Application.WebApp.Private.Operation
{
    public partial class opeAgregarAutoridaSenalada : System.Web.UI.Page
    {
        ...
        protected void btnActionAgregarAutoridad_Click(object sender, EventArgs e){
            try
            {
                ...
                if (this.hdnAutoridadId.Value == "0"){
                    ...
                    AgregarAutoridad(Convert.ToInt32(this.SolicitudIdHidden.Value));

                }else{

                    ModificarAutoridad(Convert.ToInt32(this.SolicitudIdHidden.Value));

                }

                // Recargar grid del listado de autoridades asociadas al expediente
                LlenarGridAutoridades(Convert.ToInt32(this.SolicitudIdHidden.Value));
        ...
        protected void btnVocesTemporal_Nuevo_Click(object sender, EventArgs e){
            String SolicitudId = this.SolicitudIdHidden.Value;
        ...
        protected void gvVocesTemporal_RowCommand(object sender, GridViewCommandEventArgs e){
            ...
            try
            {
                ...
                switch (strCommand){
                    case "Eliminar":
                        BorrarVoz(Int32.Parse(this.SolicitudIdHidden.Value), Int32.Parse(this.hdnAutoridadId.Value), Int32.Parse(VozId));
                        break;
                }
