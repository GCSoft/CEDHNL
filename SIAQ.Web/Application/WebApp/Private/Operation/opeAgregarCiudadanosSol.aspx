                    ...
                    <tr style="height:10px;"><td colspan="3"></td></tr>
                     <tr>
                        ...
                        <td class="tdCeldaItem">
                            <asp:Button ID="btnBuscar" runat="server" CssClass="Button_General_Verde" Text="Buscar" Width="120px"></asp:Button>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="lnkBusquedaAvanzada" runat="server" CssClass="LinkButton_Regular" Text="Busqueda avanzada"></asp:LinkButton>
                        </td>
                        <td style="width:5px;"></td>
                    </tr>   
                </table>
