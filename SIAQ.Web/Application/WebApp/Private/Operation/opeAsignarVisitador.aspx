                        ...
                        <tr>
                            <td style="height: 24px; text-align: left; width: 130px;">
                                <asp:Button ID="btnAsignarExpediente" runat="server" Text="Asignar a expediente"
                                    ...
                                    onclick="btnAsignarExpediente_Click" />
                            </td>
                            <td style="height: 24px; text-align: left; width: 130px;">
            ...
            <td>
                <asp:Panel ID="pnlGridAutoridades" runat="server" Width="100%">
                    <asp:GridView ID="gvAutoridades" runat="server" AllowPaging="false" AllowSorting="true"
                        AutoGenerateColumns="False" Width="800px" DataKeyNames="AutoridadId" OnRowDataBound="gvAutoridades_RowDataBound"
                        OnSorting="gvAutoridades_Sorting" onrowcommand="gvAutoridades_RowCommand">
                        <AlternatingRowStyle CssClass="Grid_Row_Alternating" />
                        <HeaderStyle CssClass="Grid_Header" />
                        <RowStyle CssClass="Grid_Row" />
                        <EmptyDataTemplate>
