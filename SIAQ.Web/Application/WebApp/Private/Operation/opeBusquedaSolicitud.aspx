      ...
      <tr>
         <td>
            <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr class="trFilaItem">
							<td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;Núm. de solicitud</td>
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:TextBox ID="txtNumeroSolicitud" runat="server" CssClass="Textbox_General" width="177px" ></asp:TextBox></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:TextBox ID="txtCiudadano" runat="server" CssClass="Textbox_General" width="177px" ></asp:TextBox></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboFormaContacto" runat="server" CssClass="DropDownList_General" width="183px"></asp:DropDownList></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboFuncionario" runat="server" CssClass="DropDownList_General" width="183px"></asp:DropDownList></td>
                            <td style="width:5px;"></td>
                            <td ></td>
                            <td style="width:5px;"></td>
                            <td ></td>
            ...
            <asp:Panel id="pnlBotones" runat="server" Width="100%">
               <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                     ...
                     <td style="height:24px; text-align:left; width:130px;"><asp:Button ID="cmdCancelar" runat="server" Text="Cancelar" CssClass="Button_General_Verde" width="125px" /></td>
