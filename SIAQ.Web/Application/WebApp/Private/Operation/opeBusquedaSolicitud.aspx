<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master"
    AutoEventWireup="true" CodeBehind="opeBusquedaSolicitud.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Operation.opeBusquedaSolicitud" %>

<%@ Register Src="~/Include/WebUserControls/wucCalendario.ascx" TagName="calendar"
    TagPrefix="cal" %>
                ...
                <asp:Panel ID="pnlFormulario" runat="server" Visible="true" Width="100%">
                    <table border="0" style="width: 460px">
                        <tr>
                            ...
                            <td class="Campo">
                                <asp:TextBox ID="txtNumeroSolicitud" runat="server" CssClass="Textbox_General" Width="211px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="Etiqueta">
                            ...
                            <td class="Campo">
                                <asp:TextBox ID="txtCiudadano" runat="server" CssClass="Textbox_General" Width="211px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="Etiqueta">
                            ...
                            <td class="Campo">
                                <asp:DropDownList ID="ddlFormaContacto" runat="server" CssClass="DropDownList_General"
                                    Width="216px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="Campo">
                                <asp:DropDownList ID="ddlFuncionario" runat="server" CssClass="DropDownList_General"
                                    Width="216px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="Campo">
                                <cal:calendar ID="calDesde" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="Etiqueta">
                            ...
                            <td class="Campo">
                                <cal:calendar ID="calHasta" runat="server" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="height: 24px; text-align: left; width: 130px;">
                                <asp:Button ID="cmdGuardar" runat="server" Text="Buscar" OnClick="SearchButton_Click"
                                    CssClass="Button_General" Width="125px" />
                            </td>
                            <td style="height: 24px; text-align: left; width: 130px;">
                    ...
                    <asp:GridView ID="gvSolicitud" runat="server" AllowPaging="false" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgEdit" CommandArgument='<%#Eval("SolicitudId")%>' CommandName="Editar"
