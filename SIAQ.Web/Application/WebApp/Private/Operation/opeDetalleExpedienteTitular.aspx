         ...
         <td>
            <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr style=" height:3px;"><td colspan="13"></td></tr>
                     <tr>
                        <td style="width:65px; font-size:8px;">Información general</td>
                        <td></td>
                        <td style="width:65px; font-size:8px;">Aprovar calificación</td>
                        <td></td>
                        <td style="width:65px; font-size:8px;">Asignar visitador</td>
                        <td></td>
                        <td style="width:65px;"></td>
                        <td></td>
                        <td style="width:65px;"></td>
