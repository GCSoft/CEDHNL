      ...
      <tr>
         <td>
            <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr class="trFilaItem">
                        <td colspan="3" class="style5">Solicitud Número<asp:Label ID="lbNumeroSolictud" runat="server" ></asp:Label></td>
                    ...
                    <tr class="trFilaItem">
                        ...
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtCalificacion" runat="server" CssClass="Textbox_General" Enabled="false" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                        <td class="tdCeldaLeyendaItemFondoBlanco"></td>
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"></td>
                    ...
                    <tr class="trFilaItem">
                        ...
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtEstatus" runat="server" CssClass="Textbox_General"  Enabled="false" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                        <td class="tdCeldaLeyendaItemFondoBlanco">Fecha de recepción</td>
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtFechaResepcion" runat="server" CssClass="Textbox_General"  Enabled="false" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                    </tr>
                    <tr style=" height:5px;"><td colspan="8"></td></tr>
                    <tr class="trFilaItem">
                        ...
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtFuncionario" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                        <td class="tdCeldaLeyendaItemFondoBlanco">Fecha de asignación</td>
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtFechaAsignacion" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                    </tr>
                    ...
                    <tr class="trFilaItem">
                        ...
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtFormaContacto" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                        <td class="tdCeldaLeyendaItemFondoBlanco">Fecha de inicio gestión</td>
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtFechaIniGest" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                    </tr>
                    <tr style=" height:5px;"><td colspan="8"></td></tr>
                    <tr class="trFilaItem">
                        ...
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtTipoSolicitud" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                        <td class="tdCeldaLeyendaItemFondoBlanco">Última modificación</td>
                        <td style="width:5px;"></td>
						<td class="tdCeldaItem"><asp:TextBox ID="txtUltimaModificacion" runat="server"  Enabled="false" CssClass="Textbox_General" width="177px" ></asp:TextBox>&nbsp;</td>
                        <td style="width:5px;"></td>
                    </tr>
                    <tr style=" height:5px;"><td colspan="8"></td></tr>
                    <tr class="trFilaItem">
      ...
      <tr>
         <td>
            <asp:Panel id="pnlBotones" runat="server" Width="100%">
               <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                     <td style="height:24px; text-align:left; width:130px;"><asp:Button ID="btnGuardar" runat="server" Text="Guardar información de solicitud" CssClass="Button_General" width="200px" /></td>
