<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="opeDiligenciaExpediente.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Operation.opeDiligenciaExpediente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    <table class="GeneralTable">
        ...
        <tr>
            <td>
                <asp:Panel ID="pnlDiligenciasExpediente" runat="server" Width="100%">
