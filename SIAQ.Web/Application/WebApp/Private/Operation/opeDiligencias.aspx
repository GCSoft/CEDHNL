        ...
        <tr>
            <td>
                <asp:Panel ID="pnlGridCiudadanos" runat="server" Width="100%">
                    <asp:GridView ID="gvDiligencias" runat="server" AllowPaging="false" AllowSorting="true"
                        AutoGenerateColumns="False" Width="800px" DataKeyNames="DiligenciaId" OnRowCommand="gvDiligencias_RowCommand"
                        OnRowDataBound="gvDiligencias_RowDataBound" OnSorting="gvDiligencias_Sorting">
