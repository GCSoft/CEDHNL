<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="opeRegistroSolicitudOld.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Operation.opeRegistroSolicitudOld" %>
	...
	<table class="GeneralTable">
		...
		<tr>
			<td style="text-align: left;">
				...
				<asp:Label ID="Label2" CssClass="VinetaObligatorio" Text="*" runat="server"></asp:Label>
