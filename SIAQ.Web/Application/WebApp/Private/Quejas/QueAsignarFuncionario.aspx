<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="QueAsignarFuncionario.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Quejas.QueAsignarFuncionario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
	...
	<div id="TituloPaginaDiv">
        <table class="GeneralTable">
            ...
            <tr>
                <td class="SubTitulo">
                    <asp:Label ID="Label1" runat="server" Text="Seleccione el funcionario a asignar a la solicitud."></asp:Label>
                </td>
            </tr>
        </table>
    </div>
