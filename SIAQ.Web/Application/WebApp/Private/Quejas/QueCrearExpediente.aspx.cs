	...
	public partial class QueCrearExpediente : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e){
			try
            {
				...
				ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "alert('" + gcJavascript.ClearText(ex.Message) + "'); function pageLoad(){ focusControl('" + this.ddlVisitaduria.ClientID + "'); }", true);
            }
		}
