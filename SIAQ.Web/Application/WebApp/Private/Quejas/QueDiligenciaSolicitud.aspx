...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
	...
	<div id="InformacionDiv">
		...
		<table class="SolicitudTable">
			...
			<!-- Fin de carátula   -->
			<tr>
                <td class="Nombre">Diligencias </td>
                <td class="Espacio"></td>
                <td colspan="5" style="text-align:left;">
					<asp:CheckBox ID="chkDiligencias" runat="server" CssClass="CheckBox_Regular" Checked="true" Text="La Solicitud Requiere Diligencias" AutoPostBack="True" oncheckedchanged="chkDiligencias_CheckedChanged" onclick="if ( !this.checked ) if (!confirm('Al inhabilitar las diligencias se eliminarán todas las capturas de diligencias realizadas en la solicitud, ¿Seguro que desea continuar?')) return false;" />
				</td>
            </tr>
        </table>
		<br />
				...
				<asp:Panel ID="pnlActionBody" runat="server" CssClass="ActionBody">
					<div style="margin:0 auto; width:98%;">
						<table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
							...
							<tr style="height:155px;">
								<td colspan="3">
									<CKEditor:CKEditorControl ID="ckeResultado" BasePath="~/Include/Components/CKEditor/Core/" runat="server" Height="90px"></CKEditor:CKEditorControl>
								</td>
							</tr>
							<tr style="height:5px;"><td colspan="3"></td></tr>
							<tr>
