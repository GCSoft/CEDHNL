<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="QueListadoSolicitudesAprobacion.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Quejas.QueListadoSolicitudesAprobacion" %>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="tdCeldaTituloEncabezado" style="background-image:url('../../../../Include/Image/Web/BarraTitulo.png');">
                Listado de Solicitudes por aprobar su cierre
            </td>
        </tr>
