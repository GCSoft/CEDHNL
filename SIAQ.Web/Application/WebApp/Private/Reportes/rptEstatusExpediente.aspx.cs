...
{
    public partial class rptEstatusExpediente1 : System.Web.UI.Page
    {
        ...
        {
            string script = "window.open('rptPresentaReporte.aspx?TipoReporte=Expedientes&FechaInicial=" + wucFechaInicial.BeginDate.ToString() + "&FechaFinal= " + wucFechaFinal.EndDate.ToString() + "&EstatusId= " + cboEstatus.SelectedValue.ToString() + "', '');";
        ...
        void Fillcbo()
        {
            ...
            try
            {
                ...
                ent.TipoEstatusId = 3; // Seguimiento
