...
{
    public partial class rptEstatusQuejas1 : Page
    {
        ...
        {
            string script = "window.open('rptPresentaReporte.aspx?TipoReporte=Quejas&FechaInicial=" + wucFechaInicial.BeginDate.ToString() + "&FechaFinal= " + wucFechaFinal.EndDate.ToString() + "&EstatusId= " + cboEstatus.SelectedValue.ToString() + "', '');";
