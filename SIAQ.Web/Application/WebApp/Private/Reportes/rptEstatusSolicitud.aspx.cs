...
{
    public partial class rptEstatusSolicitud1 : System.Web.UI.Page
    {
        ...
        {
            string script = "window.open('rptPresentaReporte.aspx?TipoReporte=Solicitudes&FechaInicial=" + wucFechaInicial.BeginDate.ToString() + "&FechaFinal= " + wucFechaFinal.EndDate.ToString() + "&EstatusId= " + cboEstatus.SelectedValue.ToString() + "', '');";
        ...
        void Fillcbo()
        {
            ...
            try
            {
                ...
                ent.TipoEstatusId = 2; // Visitaduria
