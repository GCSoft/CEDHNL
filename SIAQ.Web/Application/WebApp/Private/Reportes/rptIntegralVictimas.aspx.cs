...
{
	public partial class rptIntegralVictimas1 : System.Web.UI.Page
    {
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            string script = "window.open('rptPresentaReporte.aspx?TipoReporte=rptIntegralVictimas&FechaInicial=" + wucFechaInicial.BeginDate.ToString() + "&FechaFinal= " + wucFechaFinal.EndDate.ToString() + "&EstatusId= " + "1" + "', '');";
