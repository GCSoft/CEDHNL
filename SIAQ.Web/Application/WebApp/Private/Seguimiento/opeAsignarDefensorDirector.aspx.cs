...
{
    public partial class opeAsignarDefensorDirector : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //llenar combo asignar a
                selectFuncionario(recomendacionId);
                //llenar detalle
        ...
        private void selectFuncionario(string recomendacionId)
        {
