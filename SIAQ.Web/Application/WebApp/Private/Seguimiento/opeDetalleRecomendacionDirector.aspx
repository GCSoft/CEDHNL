<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="opeDetalleRecomendacionDirector.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Seguimiento.opeDetalleRecomendacionDirector" %>
    ...
    <div id="SubMenuDiv">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td style="width: 65px;">
                    <asp:ImageButton ID="AsignarVisitadorButton" ImageUrl="/Include/Image/Icon/EnviarIcon.png"
                        ...
                        <asp:GridView AutoGenerateColumns="False" AutoUpdateAfterCallBack="True" DataKeyNames="CiudadanoId"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:ImageButton ID="btnBorrar" runat="server" ImageUrl="~/Include/Image/Buttons/Delete.png" CommandName="btnBorrar"
                                         Height="16" Width="16" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
