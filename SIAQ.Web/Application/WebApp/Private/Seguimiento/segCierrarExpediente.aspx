<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="segCierrarExpediente.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Seguimiento.segCierrarExpediente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
	...
	<div id="InformacionDiv">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align: left;">
					<asp:Button ID="btnCerrar" runat="server" Text="Cerrar Expediente" CssClass="Button_General" width="125px" onclick="btnCerrar_Click" OnClientClick="return confirm('¿Seguro que desea cerrar el expediente?');" /> &nbsp;&nbsp;
