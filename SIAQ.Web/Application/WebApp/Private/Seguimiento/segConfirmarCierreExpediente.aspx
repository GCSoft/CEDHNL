   ...
   <div id="TituloPaginaDiv">
	...
	<div id="InformacionDiv">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align: left;">
					<asp:Button ID="btnCerrar" runat="server" Text="Cerrar Expediente" CssClass="Button_General" width="125px" onclick="btnCerrar_Click" OnClientClick="return confirm('¿Seguro que desea cerrar definitivamente el expediente?');" /> &nbsp;&nbsp;
					<asp:Button ID="btnDenegar" runat="server" Text="Denegar Cierre" CssClass="Button_General" width="125px" onclick="btnDenegar_Click" OnClientClick="return confirm('Está opción regresará expediente al defensor asignado, ¿Seguro que desea continuar?');" /> &nbsp;&nbsp;
