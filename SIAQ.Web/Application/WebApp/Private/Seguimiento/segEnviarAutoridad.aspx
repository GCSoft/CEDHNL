<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="segEnviarAutoridad.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Seguimiento.segEnviarAutoridad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td style="text-align: left;">
					<asp:Button ID="btnEnviar" runat="server" Text="Enviar Documento a Autoridad" CssClass="Button_General" width="200px" onclick="btnEnviar_Click" /> &nbsp;&nbsp;
					<asp:Button ID="btnRespuesta" runat="server" Text="Registrar Respuesta de Documento" CssClass="Button_General" width="200px" onclick="btnRespuesta_Click" /> &nbsp;&nbsp;
	...
	<!-- PopUp / Envio -->
	<asp:Panel id="pnlEnvio" runat="server" CssClass="ActionBlock">
		<asp:Panel id="pnlEnvioContent" runat="server" CssClass="ActionContent" style="top:100px;" Height="360px" Width="700px">
			<asp:Panel ID="pnlEnvioHeader" runat="server" CssClass="ActionHeader">
				<table border="0" cellpadding="0" cellspacing="0" style="height:100%; width:100%">
					<tr>
						...
						<td style="vertical-align:middle; width:14px;"><asp:ImageButton id="imgCloseEnvioWindow" runat="server" ImageUrl="~/Include/Image/Buttons/CloseWindow.png" ToolTip="Cerrar Ventana" OnClick="imgCloseEnvioWindow_Click"></asp:ImageButton></td>
						<td style="width:10px"></td>
					</tr>
				</table>
			</asp:Panel>
			<asp:Panel ID="pnlEnvioBody" runat="server" CssClass="ActionBody">
				<div style="margin:0 auto; width:98%;">
					<table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
						<tr style="height:20px;"><td colspan="3"></td></tr>
						<tr class="trFilaItem">
							<td class="tdActionCeldaLeyendaItem">&nbsp;Fecha de envío</td>
							<td style="width:5px;"></td>
							<td><wuc:wucCalendar ID="calFechaEnvio" runat="server" /></td>
						</tr>
						...
						<tr>
							<td colspan="3" style="text-align:right;">
								<asp:Button ID="btnPopUpEnviar" runat="server" Text="Envío" CssClass="Button_General" width="125px" onclick="btnPopUpEnviar_Click" />
							</td>
						</tr>
						<tr>
							<td colspan="3">
								<asp:Label ID="lblActionMessageEnvio" runat="server" CssClass="ActionContentMessage"></asp:Label>
							</td>
						</tr>
					</table>
				</div>
		...
		<ajaxToolkit:DragPanelExtender id="dragPanelEnvio" runat="server" TargetControlID="pnlEnvioContent" DragHandleID="pnlEnvioHeader"> </ajaxToolkit:DragPanelExtender>
	</asp:Panel>
			...
			<asp:Panel ID="pnlRespuestaBody" runat="server" CssClass="ActionBody">
				<div style="margin:0 auto; width:98%;">
					<table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
						...
						<tr style="height:5px;"><td colspan="3"></td></tr>
						<tr class="trFilaItem">
							<td class="tdActionCeldaLeyendaItem">&nbsp;Respuesta</td>
							<td style="width:5px;"></td>
							<td><asp:DropDownList ID="ddlPopUpRespuesta" runat="server" Width="216px" CssClass="DropDownList_General"></asp:DropDownList></td>
						</tr>
						<tr style="height:5px;"><td colspan="3"></td></tr>
						<tr class="trFilaItem"><td class="tdActionCeldaLeyendaItem" colspan="3">&nbsp;Detalle</td></tr>
						<tr style="height:155px;">
