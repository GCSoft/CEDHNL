<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="segListadoRecomendaciones.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Seguimiento.segListadoRecomendaciones" %>
                    ...
                    <asp:GridView id="gvRecomendacion" runat="server" AllowPaging="false" AllowSorting="true"  AutoGenerateColumns="False" Width="100%"
						...
						<EmptyDataTemplate>
							<table border="1px" cellpadding="0px" cellspacing="0px" width="100%">
                                ...
                                <tr class="Grid_Row">
                                    <td colspan="5">No se encontraron Recomendaciones/Acuerdos de no responabilidad pendientes por asignación</td>
                                </tr>
                            </table>
						</EmptyDataTemplate>
						<Columns>
