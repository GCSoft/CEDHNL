...
'
' Descripción:
'           Crear el reporte de excel de Menu
'----------------------------------------------------------------------------------------------------------------------------------*/
...
{
   public partial class xlsMenu : System.Web.UI.Page
   {
      ...
      // Utilerías
		...
		Boolean HasValidParams(String sKey, ref ENTMenu oENTMenu){
            ...
            oENTMenu.tiActivo = Int16.Parse(sKey.Split(new Char[] { '|' })[1].ToString());
		...
		protected void Page_Load(object sender, EventArgs e){
			...
			try
			{
				...
				if (!HasValidParams(this.Request.QueryString["key"].ToString(), ref oENTMenu)){
					this.Response.Redirect("~/Application/WebApp/Private/SysApp/saNotificacion.aspx?key=" + sDefaultErrorMessage, false);
				}
