   ...
   public partial class scatMenu : BPPage
   {
      ...
      private void InsertMenu(){
         ENTMenu oENTMenu = new ENTMenu();
            ...
            // Mensaje de usuario
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Convert.ToString(Guid.NewGuid()), "tinyboxMessage('Menú creado con éxito!', 'Success', false); focusControl('" + this.txtNombre.ClientID + "');", true);
      ...
      protected void gvMenu_RowDataBound(object sender, GridViewRowEventArgs e){
		...
		protected void gvMenu_Sorting(object sender, GridViewSortEventArgs e){
			...
			try{
				...
				tblRegionesTelcel = utilFunction.ParseGridViewToDataTable(this.gvMenu, true);
				...
				// Vaciar datos
				this.gvMenu.DataSource = viewRegionesTelcel;
				this.gvMenu.DataBind();
