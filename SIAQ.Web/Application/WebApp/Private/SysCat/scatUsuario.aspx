      ...
      <tr>
         <td>
            <asp:Panel id="pnlGrid" runat="server" Width="100%">
               <asp:GridView id="gvUsuario" runat="server" border="0" AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" Width="790px"
						...
						<EmptyDataTemplate>
                           ...
                           <td style="width:150px;">Área</td>
									...
									<td style="width:240px;">Nombre del Usuario</td>
                     ...
                     <asp:BoundField HeaderText="Área"               ItemStyle-HorizontalAlign="Left"    ItemStyle-Width="150px" DataField="sArea"       SortExpression="sArea"></asp:BoundField>
							...
							<asp:BoundField HeaderText="Nombre del Usuario" ItemStyle-HorizontalAlign="Left"		ItemStyle-Width="200px" DataField="sFullName"   SortExpression="sFullName"></asp:BoundField>
      ...
      <tr>
         <td>
            <asp:Panel id="pnlAction" runat="server" CssClass="ActionBlock" >
               <asp:Panel id="pnlActionContent" runat="server" CssClass="ActionContent" style="top:200px;" Height="360px" Width="400px">
