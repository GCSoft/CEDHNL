            ...
            <asp:Panel id="pnlFormulario" runat="server" Visible="true" Width="100%">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr class="trFilaItem">
                            ...
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:DropDownList ID="cboSexo" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
                            ...
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:DropDownList ID="cboNacionalidad" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
                            ...
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:DropDownList ID="cboEscolaridad" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
                            ...
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:DropDownList ID="cboOcupacion" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
							<td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;País</td>
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboPais" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;Estado civil</td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:DropDownList ID="cboEstadoCivil" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
							<td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;Estado</td>
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboEstado" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;Teléfono</td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"><asp:TextBox ID="cboTelefono" runat="server" CssClass="Textbox_General" width="150px" ></asp:TextBox>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
						</tr>
                        <tr class="trFilaItem">
							<td class="tdCeldaLeyendaItemFondoBlanco">&nbsp;Ciudad</td>
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboCiudad" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboAutoridadN1" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                            <td></td>
                            <td style="width:5px;"></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboAutoridadN2" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                            <td></td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"></td>
                        ...
                        <tr class="trFilaItem">
							...
							<td style="width:5px;"></td>
							<td class="tdCeldaItem"><asp:DropDownList ID="cboAutoridadN3" runat="server" CssClass="Textbox_General" width="150px"></asp:DropDownList>&nbsp;<font class="MarcadorObligatorio">&nbsp;*</font></td>
                            <td style="width:5px;"></td>
                            <td></td>
                            <td style="width:5px;"></td>
                            <td class="tdCeldaItem"></td>
