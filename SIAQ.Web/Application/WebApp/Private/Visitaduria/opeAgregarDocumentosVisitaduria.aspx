<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="opeAgregarDocumentosVisitaduria.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Visitaduria.opeAgregarDocumentosVisitaduria" %>
    ...
    <asp:UpdatePanel ID="DocumentUpdate" runat="server">
        <ContentTemplate>
            <table class="GeneralTable">
                ...
                <tr>
                    <td class="SubTitulo">Agregue aquellos documentos que sirvan para complementar la información del expediente</td>
                </tr>
                <tr>
                    <td>
                        <table border="0" style="width: 100%">
                            <tr>
                                ...
                                <td class="Espacio"></td>
                                <td class="Campo"><asp:Label CssClass="NumeroSolicitudLabel" ID="ExpedienteLabel" runat="server" Text="0"></asp:Label></td>
                                <td class="Espacio"></td>
                                <td class="Agregados" rowspan="6">
                                    <div id="AgregadosDiv">
                                        <div class="TituloDiv">Archivos agregados al expediente</div>
                                        ...
                                        <div class="ContenidoDiv">
                                            <asp:GridView AllowPaging="false" AllowSorting="false" AutoGenerateColumns="false" BorderWidth="0"
                                                ...
                                                <EmptyDataTemplate>
                                                    No se han agregado documentos al expediente
                                                </EmptyDataTemplate>
                                                <Columns>
