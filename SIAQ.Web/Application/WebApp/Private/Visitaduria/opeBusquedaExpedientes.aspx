            ...
            <td>
                <asp:Panel ID="pnlGrid" runat="server" Width="100%">
                    <asp:GridView ID="gvApps" runat="server" AllowPaging="false" AllowSorting="true"
                        AutoGenerateColumns="False" Width="800px" DataKeyNames="ExpedienteId,Numero"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Observaciones" HeaderText="Asunto" ItemStyle-Width="150px" SortExpression="Observaciones">
                            </asp:BoundField>
                            <asp:BoundField DataField="Fecha" HeaderText="Fecha Visitadurías" ItemStyle-Width="100px" SortExpression="Fecha"
                                DataFormatString="{0:MM-dd-yyyy}"></asp:BoundField>
                            <asp:BoundField DataField="NombreFuncionario" HeaderText="Visitador" ItemStyle-Width="150px" SortExpression="NombreFuncionario">
                            </asp:BoundField>
                            <asp:BoundField DataField="Estatus" HeaderText="Estatus" ItemStyle-Width="100px" SortExpression="Estatus">
                            </asp:BoundField>
                            <asp:BoundField DataField="NombreCiudadano" HeaderText="Quejosos" SortExpression="NombreCiudadano" ItemStyle-Width="100px" />
