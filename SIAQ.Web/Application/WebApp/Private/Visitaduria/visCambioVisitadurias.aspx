<%@ Page Title="" Language="C#" MasterPageFile="~/Include/MasterPage/PrivateTemplate.Master" AutoEventWireup="true" CodeBehind="visCambioVisitadurias.aspx.cs" Inherits="SIAQ.Web.Application.WebApp.Private.Visitaduria.visCambioVisitadurias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
	...
	<div id="InformacionDiv">
		...
		<table class="SolicitudTable">
			...
			<!-- Fin Carátula -->
			<tr>
                <td class="Nombre">Nueva Área</td>
                <td class="Espacio"><font class="MarcadorObligatorio">&nbsp;*</font></td>
                <td colspan="5" style="text-align:left;"><asp:DropDownList ID="ddlArea" runat="server" CssClass="DropDownList_General" width="216px" ></asp:DropDownList></td>
            </tr>
			<tr>
                <td class="Nombre">Comentarios</td>
                <td class="Espacio"></td>
                <td class="Campo" colspan="5"><CKEditor:CKEditorControl ID="ckeComentario" BasePath="~/Include/Components/CKEditor/Core/" runat="server" Height="200px" MaxLength="8000"></CKEditor:CKEditorControl></td>
            </tr>
        </table>
		<br />
