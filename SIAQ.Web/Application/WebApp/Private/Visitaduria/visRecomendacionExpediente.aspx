    ...
    <div id="InformacionDiv">
        <table class="SolicitudTable">
            ...
            <tr>
                ...
                <td class="Espacio"></td>
                <td class="Campo" colspan="5"><asp:DropDownList ID="TipoRecomendacionList" runat="server" CssClass="DropDownList_General" Width="198px"></asp:DropDownList></td>
            </tr>
            <tr>
                <td class="Nombre">Recomendación</td>
                <td class="Espacio"></td>
                <td class="Campo" colspan="5"><asp:TextBox ID="RecomendacionBox" runat="server" CssClass="Textbox_General" TextMode="MultiLine" Height="100px" width="360px" ></asp:TextBox></td>
            </tr>
            <tr>
