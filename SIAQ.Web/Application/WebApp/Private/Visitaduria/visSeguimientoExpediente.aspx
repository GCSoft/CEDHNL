...
<asp:Content ID="BodyContent" ContentPlaceHolderID="cntPrivateTemplateBody" runat="server">
    ...
    <div id="InformacionDiv">
        <table class="SolicitudTable">
            ...
            <tr>
                <tr>
                    <td colspan="7"><CKEditor:CKEditorControl ID="SeguimientoBox" BasePath="~/Include/Components/CKEditor/Core/" runat="server" MaxLength="8000"></CKEditor:CKEditorControl></td>
                </tr>
            </tr>
            <tr>
