...
<div style="background-color:#D5E9F3; border:1px solid #5E8291; left:0px; text-align:center; top:0px;  width:214px;">
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td style="text-align:left; width:194px;"><asp:TextBox ID="txtCiudadano" runat="server" Width="183px"></asp:TextBox></td>
...
<asp:Panel ID="pnlAction" runat="server" CssClass="ActionBlock">
    <asp:Panel ID="pnlActionContent" runat="server" CssClass="ActionContent" style="top:150px;" Height="305px" Width="750px">
            ...
            <div style="margin:0 auto; width:98%;">
                <table border="0" cellpadding="0" cellspacing="0" style="height:100%; text-align:left;" width="100%">
                   ...
                   <tr style="height:155px;">
                      <td colspan="4">
                         <div style="border:1px solid #4B4878; height:170px; overflow-x:hidden; overflow-y:scroll; text-align:left; width:718px;">
				            <asp:GridView ID="gvCiudadano" runat="server" AllowSorting="True" 
                                 AutoGenerateColumns="False" BorderWidth="0px" Width="700px"
                                ...
                                <EmptyDataTemplate>
                                    <table border="1px" cellpadding="0px" cellspacing="0px">
                                        ...
                                        <tr class="Grid_Row">
                                            <td colspan="5" style="text-align:center;">No se encontraron Ciudadanos</td>
                                        </tr>
                                    </table>
                                </EmptyDataTemplate>
                                <Columns>
                                    <asp:BoundField   HeaderText="ID"    HeaderStyle-HorizontalAlign ="Center"  ItemStyle-HorizontalAlign="Left" Visible="false" DataField="CiudadanoId"></asp:BoundField>
                                    ...
                                    <asp:BoundField   HeaderText="Fecha Nacimiento"   HeaderStyle-HorizontalAlign ="Center"  ItemStyle-HorizontalAlign="Left" ItemStyle-Width="100px"	SortExpression="FechaNacimiento" DataField="FechaNacimiento"></asp:BoundField>
